...
It takes advantage of conhost's ability(that seems to have been lost in the new windows terminal) to set the font size in the shortcut which I then hex edited to make smaller than it usually allows, after that it was pretty easy to get a decent display into the windows terminal
